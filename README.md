...
git clone https://github.com/softtent/softtent-todox.git
...
After running `release` command, there will be a folder called `/dist` will be generated at the root directory with `softtent-managex.zip` project files.
